...
# Examples with different architectures producing identical results
...
## Fault tinyAES compiled for RISC-V
    ./faultfinder experiments/tiny-AES-riscv/jsons/fault.json

To view the outputs:
* ```cat experiments/tiny-AES-riscv/outputs/*  | grep Output| sort | uniq -c```
