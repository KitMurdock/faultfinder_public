...
#define STRUCTS_H_INCLUDED
    ...
    typedef struct _line_details_t
    {
        ...
        bool equivalent;
        bool checkpoint;
        uint64_t* memory_main;   // For checkpoints
        uint64_t** memory_other; // For checkpoints
        uint64_t* stack;         // For checkpoints
    ...
    typedef struct _run_state_t
    {
        ...
        uc_hook hk_mem_invalid;
        uc_hook hk_fault_lifespan;
        uc_hook hk_equivalent;
        // Used to start at a checkpoint rather than the beginning
        line_details_t* line_details_array;
        //starts the run from the nearest checkpoint not the beginning
